...
const ShoppingCart = () => {
  ...
  const [cartItems, setCartItems] = useState([
    ...
    },
    {
      ...
      author: "Jack London",
      price: 15.99,
      originalPrice: 19.99, // This one has a discount
      quantity: 1,
      image: "https://upload.wikimedia.org/wikipedia/commons/6/68/The_Iron_Heel.jpg"
    },
    {
      id: 3,
      name: "Klara and the Sun",
              ...
              <div className="item-price">
                ...
                <div className="price-info">
                  {item.originalPrice > item.price ? (
                    <>
                      <p className="original-price source-sans-light">Original price:</p>
                      <p className="strikethrough-price source-sans-light">${item.originalPrice.toFixed(2)}</p>
